# based on 1.9
# project : rotating infinite cylinder => fail but i like the result
...
def main():
    ...
    edges, vertices = create_rotating_cylinder1(cyl_pos, r, p)
    print("edges : " + str(edges))
    ...
    while True:
        ...
        if is_circle_visible(cam_pos_z, cyl_pos[0][2]) == 1:
            ...
            edges, vertices = create_rotating_cylinder1(cyl_pos, r, p, circle_counter)
            circle_counter += 1
